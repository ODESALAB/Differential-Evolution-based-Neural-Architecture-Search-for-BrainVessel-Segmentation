...
class DE():
    ...
    def get_opposite_model(self, model, a = 0, b = 1):
        ...
        opposite_model = Model(opposite_chromosome, config, self.CELLS[config[-2]], self.FILTERS[config[-1]])
    ...
    def evolve_generation(self):
        ...
        for j in range(self.pop_size):
            ...
            if isSameSolution:
                ...
                mutant = Model(sol["chromosome"], cfg, self.CELLS[cfg[-2]], self.FILTERS[cfg[-1]])
